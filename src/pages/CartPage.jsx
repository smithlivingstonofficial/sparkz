...
const CartPage = () => {
  ...
  const totals = useMemo(() => {
    // Event fee is 0 for KLU students, 300 for others (only if cart not empty)
  ...
  const openUPIApp = () => {
    const upiLink = `upi://pay?pa=${sparkzUPI}&pn=SPARKZ%2026&am=${totals.total}&tn=Sparkz%20Registration&cu=INR`;
